...
const Footer = ()=> {
  return (
    <footer className="text-center relative top-32 h-16 sm:h-20 w-full sm:pt-2 pt-4 border-t mt-5 flex sm:flex-row flex-col justify-between items-center px-3 space-y-3 sm:mb-0 mb-3 border-gray-500">
      <div className="text-gray-500">
        Powered by{" "}
        <Link
          to="https://replicate.com/"
          target="_blank"
          rel="noreferrer"
      ...
      <div className="flex space-x-4 pb-4 sm:pb-0">
        ...
        <Link
          to="https://github.com/Nutlope/roomGPT"
          className="group"
