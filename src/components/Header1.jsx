    ...
    <>
      <header
        className={`header top-0 left-0 z-40 flex w-full items-center bg-transparent ${
          sticky
            ? "!fixed !z-[9999 bg-transparent  shadow-sticky backdrop-blur-sm !transition dark:!bg-primary dark:!bg-opacity-20"
            : "absolute"
        }`}
      >
          ...
          <div className="relative -mx-4 flex items-center justify-between">
            <div className="w-60 max-w-full px-4 xl:mr-12">
              ...
              >
                ...
                <h1 className="ml-3 text-white sm:text-3xl text-xl font-bold ml-2 tracking-tight">
                  roomGPT.io
                </h1>
              </Link>
            </div>
